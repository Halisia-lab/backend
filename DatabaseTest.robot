...
Connect DB
    ...
    @{query}=  Execute Sql String  INSERT INTO users(users_id, address, city, email, first_name, last_name, password, phone_number, post_index) VALUES (5,'15 rue', 'Paris', 'test@gmail.com', 'Test', 'Name', 'password123', '0612341212', 75000) returning email;
